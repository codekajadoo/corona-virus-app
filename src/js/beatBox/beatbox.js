const keyData = {
	1: {
        sound: new Howl({
            urls: ["../audio/beatBox/tom.wav"]
        }),
        color: "#db1d2d"
    },
    2: {
        sound: new Howl({
            urls: ["../audio/beatBox/clap.wav"]
        }),
        color: "#f0421c"
    },
    3: {
        sound: new Howl({
            urls: ["../audio/beatBox/kick.wav"]
        }),
        color: "#fec02d"
    },
    4: {
        sound: new Howl({
            urls: ["../audio/beatBox/openhat.wav"]
        }),
        color: "#20d071"
    },
    5: {
        sound: new Howl({
            urls: ["../audio/beatBox/boom.wav"]
        }),
        color: "#1a9ddb"
    },
    6: {
        sound: new Howl({
            urls: ["../audio/beatBox/ride.wav"]
        }),
        color: "#a13fad"
    },
    7: {
        sound: new Howl({
            urls: ["../audio/beatBox/snare.wav"]
        }),
        color: "#f26fd4"
    },
    8: {
        sound: new Howl({
            urls: ["../audio/beatBox/wipe.mp3"]
        }),
        color: "#404be6"
    },
    9: {
        sound: new Howl({
            urls: ["../audio/beatBox/splits.mp3"]
        }),
        color: "#00ff04"
    }
};
